...
**Status: In Progress**
**Current checkpoint:** CP-064 — deterministic SIP fault corpus locally validated
**Last checkpoint (UTC):** 2026-09-01T07:43:08Z
**Active phase:** Phase 1 — Rust media engine
**Active milestone:** Offline deterministic verification foundation across Milestones 2–5<br>
**Next resume action:** Publish PR #26 with a pinned force-with-lease and verify hosted checks plus mergeability
**Active PR:** Pre-publication branch `sip-scenario-faults` targets [#25](https://github.com/W3Mirror/asterisk/pull/25)'s branch `sip-scenario-replay`
...
| Phase 1 — Rust media engine | in_progress | CP-018/CP-026/CP-047/CP-049/CP-050/CP-054/CP-056/CP-058/CP-059/CP-060/CP-061/CP-062/CP-063/CP-064; PR #2 foundation, PR #8 media/DTMF/recording, PR #18 bounded WebSocket adapter, PR #19 bounded stream driver, PR #20 UDP runtime, PR #21 parser fuzz harnesses, PR #22 hosted CI/offline verification contract, PR #25 deterministic SIP scenario replay, and PR #26 deterministic fault corpus; focused and full offline workspace tests pass | [#26](https://github.com/W3Mirror/asterisk/pull/26) | Publish and verify PR #26, then implement deterministic transfer/bridge coverage |
| Offline deterministic verification | in_progress | CP-058/CP-059/CP-060/CP-061/CP-062/CP-063/CP-064 define focused per-module tests, synthetic SIP replay, property invariants, API/event contracts, media fault injection, bridge/transfer state tests, differential tooling, load/soak/reclamation tiers, and hosted PR/main-push execution semantics | [#26](https://github.com/W3Mirror/asterisk/pull/26) | Extend the replay foundation with deterministic transfer and bridge scenarios |
| Synthetic SIP scenario replay | in_progress | CP-061/CP-062/CP-063/CP-064; PR #25 provides bounded atomic normal-call replay and PR #26 adds CANCEL/final-response cleanup, INVITE retransmission, RTP loss/reordering, DTMF duplicate suppression, and RTCP receiver-report replay with seven focused tests; local full workspace (136 tests) and hosted PR #25 checks pass | [#26](https://github.com/W3Mirror/asterisk/pull/26) | Publish PR #26 and verify hosted checks plus mergeability |
